...
describe('creating posts', () => {
  test('with all parameters should succeed', async () => {
    const post = {
      ...
      author: 'Daniel Grieg',
      contents: 'This post is sorted in a MongoDB database using Mongoose.',
...
const samplePosts = [
  ...
  { title: 'Learning React Hooks', author: 'Patrick Paul', tags: ['react'] },
...
describe('Deleting posts', () => {
  test('should remove the post from the databse', async () => {
